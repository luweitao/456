<%@ page language="java" contentType="text/html; charset=utf-8"
    pageEncoding="utf-8" import="com.wt.po.User,java.text.SimpleDateFormat"%>
  ...
  <tr>
    <td colspan="2" valign="top"  ><table width="700" border="0" align="center" cellpadding="0" cellspacing="0">
      ...
      <table width="263" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr>
          <td height="30" align="center"><input name="button" type="button" class="butxg" id="button"value="修改" onclick="UpdateInfo()"></td>
          </tr>
      </table>
    </table>
  <table width="100%" border="0" cellspacing="0">
