<%@ page import="com.wt.po.User,java.text.SimpleDateFormat" %>
      ...
      <tr>
        ...
        <table width="700" border="0" align="center" cellpadding="0" cellspacing="0">
          ...
          <tr>
            ...
            <td width="350" align="left" class="text_cray1"><input name="textfield22" type="text" disabled="true" class="text_cray" id="textfield22" value="1" readonly="readonly"/></td>
            <td width="230" colspan="-1" rowspan="7" align="center" background="../img/bg_point_write.gif" class="text_cray1"><img src="../img/photo_mr.jpg" width="120">              <table width="90%" border="0" cellpadding="0" cellspacing="0">
                <tr>
                  <td height="15" ></td>
                </tr>
                <tr>
          ...
          <tr>
            ...
            <td align="left" class="text_cray1"><input name="textfield2" type="text" disabled="true" class="text_cray" id="textfield2" value="2" readonly="readonly"/></td>
          </tr>
          <tr>
            <td width="20" ></td>
...
<span><label></label>
          ...
          <tr>
            ...
            <td align="left" class="text_cray1"><input name="textfield2" type="text" disabled="true" class="text_cray" id="textfield2" value="" readonly="readonly"/>            </td>
          </tr>
          <tr>
            <td width="20" align="center" class="text_red">*</td>
            <td width="100" height="40" align="left" class="text_cray1">城市：</td>
            <td align="left" class="text_cray1"><input name="textfield2" type="text" disabled="true" class="text_cray" id="textfield2" value="4" readonly="readonly"/>            </td>
          </tr>
          <tr>
            <td width="20" align="center" class="text_red">*</td>
            <td width="100" height="40" align="left" class="text_cray1">证件类型：</td>
            <td align="left" class="text_cray1"><input name="textfield2" type="text" disabled="true" class="text_cray" id="textfield2" value="5" readonly="readonly"/>            </td>
          </tr>
          <tr>
            <td width="20" align="center" class="text_red">*</td>
        ...
        <table width="700" border="0" align="center" cellpadding="0" cellspacing="0">
          <tr>
            <td width="164"></td>
            <td width="99" height="30" align="center"><input name="button" type="submit" class="buttj" id="button"value="确认"></td>
            <td width="98" ></td>
            <td width="97" align="center"><input name="button2" type="submit" class="butcz" id="button2"value="重置"></td>
            <td width="92" ></td>
          </tr>
        </table>
  </table>
...
<table width="100%" border="0" cellspacing="0">
  ...
  <tr>
    <td height="25" align="center" background="../img/bottom_ny_bg.gif" class="text_cray">copyright@12306 è´­ç¥¨ç½</td>
  </tr>
</table>
</td>
  </tr>
